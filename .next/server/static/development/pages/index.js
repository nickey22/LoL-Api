...
const NoSummonerSearched = props => {
...
/* harmony import */ var _match_panels_GameDuration__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./match-panels/GameDuration */ "./components/summoner-profile/summoner-matches/single-match/match-panels/GameDuration.js");
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
const MatchData = props => {
  ...
  const championImage = __jsx("img", {
    src: `/static/ddragon/img/champion/${champion.image.full}`
  });

  return __jsx("div", {
    className: "match-wrapper"
  }, __jsx(_match_panels_GameDuration__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
/* harmony import */ var _MatchData__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./MatchData */ "./components/summoner-profile/summoner-matches/single-match/MatchData.js");
...
class SummonerMatch extends react__WEBPACK_IMPORTED_MODULE_3___default.a.Component {
  constructor(...args) {
    super(...args);
  ...
  componentDidMount() {
    ...
    _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_1___default()(championData).forEach(champ => {
  ...
  render() {
    ...
    if (this.state.person !== null) {
      ...
      championData = __jsx(_MatchData__WEBPACK_IMPORTED_MODULE_4__["default"], {
        matchWon: matchWon,
        match: match,
...
const ChampionItems = props => {
  ...
  const itemsJSON = _static_ddragon_db_item_json__WEBPACK_IMPORTED_MODULE_1__.data;
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      src: `/static/ddragon/img/item/${itemsJSON[item].image.full}`,
      alt: "item"
    }));
  })));
};
...
/* harmony import */ var _components_wrappers_Layout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/wrappers/Layout */ "./components/wrappers/Layout.js");
/* harmony import */ var _components_SummonerSearch__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/SummonerSearch */ "./components/SummonerSearch.js");
/* harmony import */ var _components_Summoner__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/Summoner */ "./components/Summoner.js");
...
class Index extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  constructor(...args) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])(this, "getSummonerByName", async event => {
      this.setState({
        currentSummoner: null
      });
      event.preventDefault();
      const summonerNameToGet = document.querySelector("#summonerNameSearch").value;
      const apiRequest = await isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()('/api/user/getSummonerByName', {
        method: 'POST',
        headers: {
  ...
  render() {
    ...
    return __jsx(_components_wrappers_Layout__WEBPACK_IMPORTED_MODULE_4__["default"], {
      pageView: "homepage",
      pageTitle: "Homepage"
    }, __jsx(_components_SummonerSearch__WEBPACK_IMPORTED_MODULE_5__["default"], {
      searchSummoner: event => this.getSummonerByName(event)
    }), __jsx("div", {
      className: "info-wrapper"
    }, __jsx(_components_Summoner__WEBPACK_IMPORTED_MODULE_6__["default"], {
      summoner: summoner
    })));
  }
...
/***/ "./sass/partials/summoner-profile.sass":
/*!*********************************************!*\
  !*** ./sass/partials/summoner-profile.sass ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./sass/partials/summoner-search.sass":
/*!********************************************!*\
  !*** ./sass/partials/summoner-search.sass ***!
  \********************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! /home/vagrant/apps/league/pages/index.js */"./pages/index.js");
